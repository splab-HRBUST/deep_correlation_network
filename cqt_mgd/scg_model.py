...
class GatedRes2Net(nn.Module):
    def __init__(self, block, layers, baseWidth=26, scale=4, m=0.35, num_classes=1000 ,loss='softmax', gate_reduction=4,
                 **kwargs):
        self.inplanes = 16
...
if __name__ == '__main__':
    ...
    model = se_gated_linearconcat_res2net50_v1b(pretrained=False,loss='oc-softmax')#embedding 512
