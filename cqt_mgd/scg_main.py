...
from models3 import AttenResNet4,GatedRes2Net
from syz import resnet18_cbam 
...
if __name__ == '__main__':
    ...
    #print("device:",device)
    if not os.path.exists('cbam_models'):
        os.mkdir('cbam_models')
    ...
    model_save_path = os.path.join('cbam_models', model_tag)    
    ...
    df.to_csv("cbam.csv",index=False)
    ...
    for epoch in range(start_epoch+1,num_epochs+1):
        ...
        data.to_csv("cbam.csv",mode='a',header=False,index=False)#mode设为a,就可以向csv文件追加数据了
